-- ============================================================================
-- UPDATE: vw_creative_analysis_complete (v3.5) - FORCE INCLUDE ULTEC
-- Purpose: Explicitly include 'Ultec' campaigns even if mapped as 'is_ignored'.
--          Persists the NULL entity_id fix.
-- ============================================================================
...
WHERE p.platform = 'META'
  -- FORCE INCLUDE ULTEC even if mapped as ignored
  AND (
